            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
                        ...
                        <div class="form-signin<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                        ...
                        <div class="form-signin<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                        ...
                        <div class="form-signin">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-default" href="<?php echo e(route('password.request')); ?>">
