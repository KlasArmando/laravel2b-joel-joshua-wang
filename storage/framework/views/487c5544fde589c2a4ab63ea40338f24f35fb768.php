<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['action' => ['AdminController@updateUser', $user->id], 'method' => 'POST']); ?>
    ...
    <div class="form-group">
        ...
        <?php echo e(Form::text('password', $user->password, ['class' => 'form-control', 'placeholder'=>'Password'])); ?>
